...
func (ec *executionContext) _Entity_findGameByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *model.Game) graphql.Marshaler {
			return ec.marshalNGame2ᚖgameᚑsubgraphᚋgraphᚋmodelᚐGame(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_game(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *model.Game) graphql.Marshaler {
			return ec.marshalOGame2ᚖgameᚑsubgraphᚋgraphᚋmodelᚐGame(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) marshalNGame2gameᚑsubgraphᚋgraphᚋmodelᚐGame(ctx context.Context, sel ast.SelectionSet, v model.Game) graphql.Marshaler {
	return ec._Game(ctx, sel, &v)
}

func (ec *executionContext) marshalNGame2ᚖgameᚑsubgraphᚋgraphᚋmodelᚐGame(ctx context.Context, sel ast.SelectionSet, v *model.Game) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOGame2ᚖgameᚑsubgraphᚋgraphᚋmodelᚐGame(ctx context.Context, sel ast.SelectionSet, v *model.Game) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Game(ctx, sel, v)
